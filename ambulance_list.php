	...
	<main>
		<div id="results">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h4>Showing ambulance list . . . .</h4>
					</div>
					<div class="col-md-6">
                        <form method="post" action="ambulance_list.php">
                            <div class="search_bar_list">
                                <input type="text" name="search" class="form-control" required placeholder="Search by Name, Type, Area ....">
			...
			<div class="row">
				<div class="col-lg-7">
                   ...
                   if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                       ...
                       $sql="SELECT * FROM ambulance WHERE name LIKE '%$search_text%' OR address LIKE '%$search_text%' OR ambulance_type LIKE '%$search_text%'";
                   ...
                   if($num_rows<=0)
                   {
                       ...
                       echo "<h2>Sorry ! No Ambulance Found!</h2>";
					  ...
					  while($row = mysqli_fetch_array($result)) {
                          ...
                          echo "<figure>";
                          echo "<img src='img/ambulance.svg'>";
                          echo "</figure>";
                          echo "<small>" . $row['ambulance_type'] . "</small>";
                          echo "<h3>" . $row['name'] . "</h3>";
                          echo "<p>" . $row['address'] . "</p>";
                          // echo 	"<h6>Phone</h6> <a href=\"tel://\".$row['cell'].">".$row['cell']</a></li>"  ;
                          echo "<p>" . $row['cell'] . "</p>";
				...
				<aside class="col-lg-5" id="sidebar">
                    <script src="http://h2.flashvortex.com/display.php?id=2_1544337338_34830_364_0_585_91_9_2_47" type="text/javascript"></script>
					</div>
				</aside>
				<!-- /aside -->

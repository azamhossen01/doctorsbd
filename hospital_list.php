	...
	<main>
		<div id="results">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<h4>Showing Hospitals list . . . .</h4>
					</div>
					<div class="col-md-6">
                        <form method="post" action="hospital_list.php">
			...
			<div class="row">
				<div class="col-lg-7">
                   ...
                   if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                       ...
                       $sql="SELECT * FROM hospitals WHERE name LIKE '%$search_text%' OR address LIKE '%$search_text%' OR type LIKE '%$search_text%'";
                   ...
                   if($num_rows<=0)
                   {
                       ...
                       echo "<h2>Sorry ! No Hospital Found!</h2>";
                       ...
                       while ($row = mysqli_fetch_array($result)) {
                           ...
                           echo "<li><a href=\"detail_hospital.php?id=$id\">Details</a></li>";
                           echo "</ul>";
                           echo "</div>";
				...
				<aside class="col-lg-5" id="sidebar">
                    ...
                    <script src="http://h2.flashvortex.com/display.php?id=2_1544336150_47774_364_0_425_91_9_2_47" type="text/javascript"></script>
				</aside>
				<!-- /aside -->

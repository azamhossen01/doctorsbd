...
$name=$email = $division=$address=$type=$cell=$bed=$facility=$description=$time=$days=$cabin= '';
$nameErr=$emailErr = $divisionErr=$addressErr=$typeErr=$cellErr=$bedErr=$facilityErr=$descriptionErr=$timeErr=$daysErr=$cabinErr= '';
if ( (isset($_POST['name'])) != "" && (isset($_POST['division'])) != "0" &&  (isset($_POST['address'])) != "" &&  (isset($_POST['cell'])) != ""  &&  (isset($_POST['cabin'])) != "" && $_SERVER["REQUEST_METHOD"] == "POST") {
   ...
   if (empty($name)) { // checking your name
	 ...
	 else if (empty($cabin)) { // checking your name
        $cabinErr = "* Please Enter Cabin!<BR>";
        $status = "NOTOK";
    }

     else if (empty($bed)) { // checking your name
         $bedErr = "* Please Enter bed!<BR>";
         $status = "NOTOK";
     }

     else if (empty($facility)) { // checking your name
    ...
    if ($status == "OK") {
        ...
        $result = mysqli_query($con,"SELECT * FROM hospitals where name='$name'");
        ...
        if ($num_rows > 0) {
            ...
            if (mysqli_query($con,"INSERT INTO hospitals (`name`,`address`,`division`,`cell`,`email`,`type`,`description`,`facility`,`time`,`days`,`general_bed`,`cabin`) VALUE ('$name','$address','$division','$cell','$email','$type','$description','$facility','$time','$days','$bed','$cabin')")) {
                echo '<script type="text/javascript">';
                ...
                echo '<script type="text/javascript">';
                echo "setTimeout(function () { window.open('view_hospital.php','_self')";
                echo '}, 1500);</script>';
    ...
    <div class="main-panel">
        ...
        <form role="form" id="student_info_form" name="form3" method="post" action="add_hospital.php">
            ...
            <div class="col-xs-10">
                ...
                <button id="my_button" type="button" class="btn btn-danger btn-fill pull-left" onClick="window.open('view_hospital.php','_self')"><i class="fa fa-align-justify"></i>View Hospital</button>
        <button id="my_button" type="button" class="btn btn-info btn-fill pull-left" onClick="window.open('add_hospital.php','_self')"><i class="fa fa-align-justify"></i>Add Hospital</button>
            ...
            <div class="form-group">
                <div class="col-xs-10">
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <textarea class="form-control" name="description" placeholder="Enter Hospital Description" rows="5" id="comment"></textarea>
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <textarea class="form-control" name="facility" placeholder="Enter Hospital Facility" rows="5" id="comment"></textarea>
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="time" placeholder="Enter Hospital Time">
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="days" placeholder="Enter Open Days">
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="number" class="form-control" name="general_bed" placeholder="Enter Available General Bed">
                    ...
                    <div class="input-group ">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="number" class="form-control" name="cabin" placeholder="Enter Hospital Cabin">

                    </div>

                    <span class="error"> <?php echo $cabinErr; ?></span>
                    <br>

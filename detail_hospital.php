...
<body>
	...
	<main>
		<div id="breadcrumb">
			<div class="container">
				<p><strong>Showing Hospital Details</strong></p>
			</div>
		</div>
		<!-- /breadcrumb -->
							...
							<div class="profile">
								<div class="row">
									<div class="col-lg-5 col-md-4">
										<figure>
											<img src="img/hospital.svg" alt="" class="img-fluid">
										</figure>
									</div>
									<div class="col-lg-7 col-md-8">
										...
										<li>
											...
											<li>
												<h6>Phone</h6> <a href="tel://<?php echo $row['cell']?>"><?php echo $row['cell'] ?></a></li>
												
												<li>
												<h6>Email</h6> <a href="tel://<?php echo $row['email']?>"><?php echo $row['email'] ?></a></li>
										</ul>
									</div>
								</div>
							</div>
							...
							<ul class="treatments clearfix">
								<li>
									<div class="checkbox">
										...
										<label for="visit1" class="css-label">General Bed<strong><?php echo $row['general_bed']?></strong></label>
									</div>
								</li>
								<li>
									<div class="checkbox">
										<input type="checkbox" class="css-checkbox" id="visit2" name="visit2">
										<label for="visit2" class="css-label">Cabin <strong><?php echo $row['cabin']?></strong></label>
									</div>
								</li>

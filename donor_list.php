...
<main>
    <div id="results">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h4>Showing blood donors list . . .</h4>
                </div>
                ...
                <div class="col-md-6">
                    <form method="post" action="donor_list.php">
                        <div class="search_bar_list">
                            <input type="text" name="search" class="form-control" required placeholder="Search by Blood Group, Area, Gender...">
        ...
        <div class="row">
            <div class="col-lg-7">
                ...
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $sql="SELECT * FROM blood_donor WHERE blood_group LIKE '%$search_text%' OR address LIKE '%$search_text%' OR gender LIKE '%$search_text%'";
                ...
                if($num_rows<=0)
                {
                    ...
                    echo "<h2>Sorry ! No Donors Found!</h2>";
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                        ...
                        echo "<div class='strip_list wow fadeIn'> ";
                        echo "<a href=\"#0\" >" . $row['blood_group'] . "</a><br>";

                        echo "<figure>";
                        echo "<img src='img/blood.svg'>";
                        echo "</figure>";
            ...
            <aside class="col-lg-5" id="sidebar">
                <script src="http://h2.flashvortex.com/display.php?id=2_1544337911_20080_364_0_597_91_9_2_47"
